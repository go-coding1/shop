...
<head>
	...
	/*
		...
		#container_box table th { font-size:20px; font-weight:bold; text-align:center; padding10px; border-bottom: 2px solid #666;}
		#container_box table tr:hober { background:#eee; }
			...
			<ul>
				...
				<li>
					<div class="replyInfo">
						...
						<p>
							<span>작성한 상품</span><a href="/shop/view?n=${reply.gdsNum }">바로 가기</a>
						</p>
					</div>
					...
					<div class="replyControll">
						<form role="form" method="post">
							...
							<button type="submit" class="delete_${repy.repNum }_btn">삭제</button>
						</form>
